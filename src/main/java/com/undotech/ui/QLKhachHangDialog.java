...
public class QLKhachHangDialog extends javax.swing.JDialog {
    ...
    void setForm(int id) {
        ...
        txtName.setText(khNew.getTenKH());
        txtPhone.setText(khNew.getSDT());
        txtEmail.setText(khNew.getEmail());
    ...
    private void initComponents() {
        ...
        txtAddress = new com.undotech.utils.TextField();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                QLKhachHangDialog dialog = new QLKhachHangDialog(new javax.swing.JFrame(), true, int maKH);
...
//                dialog.setVisible(true);
    ...
    private com.undotech.utils.TextField txtAddress;
