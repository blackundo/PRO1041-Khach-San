 ...
 * @author Vox
 */
public class Form_QLDichVuDialog extends javax.swing.JDialog {

    /**
     * Creates new form Form_QLDichVuDialog
     */
    public Form_QLDichVuDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_QLDichVuDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_QLDichVuDialog dialog = new Form_QLDichVuDialog(new javax.swing.JFrame(), true);
