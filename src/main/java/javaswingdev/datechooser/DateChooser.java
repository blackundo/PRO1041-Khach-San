...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new javaswingdev.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new javaswingdev.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new javaswingdev.datechooser.Button();
        cmdPrevious = new javaswingdev.datechooser.Button();
        slide = new javaswingdev.datechooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/undotech/icons/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/undotech/icons/previous.png"))); // NOI18N
    ...
    private javaswingdev.datechooser.Button cmdForward;
    private javaswingdev.datechooser.Button cmdMonth;
    private javaswingdev.datechooser.Button cmdPrevious;
    private javaswingdev.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private javaswingdev.datechooser.Slider slide;
